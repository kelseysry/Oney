...
from .api.credit_routes import credit_routes
...
app.register_blueprint(review_routes, url_prefix='/api/products')
...
app.register_blueprint(credit_routes, url_prefix='/api/credits')
db.init_app(app)
Migrate(app, db)
