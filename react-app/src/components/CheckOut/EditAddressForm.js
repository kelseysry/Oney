...
const EditAddressForm = ({userAddress, user_id, setShowModal, showModal}) => {
  ...
  const [aptSuiteOther, setAptSuiteOther] = useState(userAddress?.apt_suite_other)
  ...
  const onSubmit = async (e) => {
    ...
    if (frontErrors.length === 0) {
      ...
      const editUserAddress = {full_name, country, street_address, aptSuiteOther, zip_code, city, state, user_id}
